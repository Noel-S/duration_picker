...
class DialPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final textDurationValuePainter = TextPainter(
      ...
      text: TextSpan(
        ...
        style: Theme.of(context).textTheme.headlineMedium!.copyWith(fontSize: size.shortestSide * 0.15),
      ),
  ...
  bool shouldRepaint(DialPainter oldDelegate) {
    return oldDelegate.labels != labels || oldDelegate.backgroundColor != backgroundColor || oldDelegate.accentColor != accentColor || oldDelegate.theta != theta;
  }
}
